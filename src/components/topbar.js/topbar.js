        ...
        <ul className="navbar-nav ml-auto">
          ...
          <li className="nav-item dropdown no-arrow mx-1">
            ...
            <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
              ...
              <Link className="dropdown-item d-flex align-items-center" href="#">
                <div className="dropdown-list-image mr-3">
                  <img className="rounded-circle" src="https://source.unsplash.com/LinkU4VPcFN4LE/60x60" alt="" />
          ...
          <li className="nav-item dropdown no-arrow">
            <Link className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              {/*   <span className="mr-2 d-none d-lg-inline text-gray-600 small">Dr.Mohamed </span>
                <img className="img-profile rounded-circle" src="default-profile.png" /> */}
              <span className="mr-2 d-none d-lg-inline text-gray-600 small">Mr.Tareq </span>
              <img className="img-profile rounded-circle" src="../../lab.png" alt='profile' />
            </Link>
